...
To optimize the ToDoApp application for production, run:
...
[Doing microservices with JHipster]: https://jhipster.github.io/documentation-archive/v4.0.7/microservices-architecture/
